...
LOG_DIR="/mnt/sdb-seagate/graduacao/logs/ana_pedro/evaluations/yolov5s"
mkdir -p "$LOG_DIR"
...
for ((i=0; i<${#datasets[@]}; i+=2)); do
    ...
    MODEL_NO_AUG="../../../runs/yolov5s/no_augmentation/$NAME/weights/best.pt"
    ...
    # MODEL_AUG="../../../runs/yolov5s/augmented/$NAME/weights/best.pt"
