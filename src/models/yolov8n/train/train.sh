...
LOG_DIR="/mnt/sdb-seagate/graduacao/logs/ana_pedro/train/seed${SEED}/yolo8n"
mkdir -p "$LOG_DIR"

PYTHON="/mnt/sdb-seagate/graduacao/home/ana_pedro/projetos/cerrado_tree_identifier/.venv/bin/python3"

cd /mnt/sdb-seagate/graduacao/home/ana_pedro/projetos/cerrado_tree_identifier/src/models/yolov8n/train/
...
echo "yolo8n seed=$SEED completed!"