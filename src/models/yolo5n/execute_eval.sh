...
LOG_DIR="/mnt/sdb-seagate/graduacao/logs/ana_pedro/evaluations/yolov5n"
mkdir -p "$LOG_DIR"
...
for ((i=0; i<${#datasets[@]}; i+=2)); do
    ...
    MODEL_NO_AUG="../../../runs/yolov5n/no_augmentation/$NAME/weights/best.pt"
    ...
    MODEL_AUG="../../../runs/yolov5n/augmented/$NAME/weights/best.pt"
